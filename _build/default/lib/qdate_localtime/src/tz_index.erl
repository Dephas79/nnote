...
lookup("UTC") -> ["Etc/UTC","Antarctica/Troll","Etc/Universal","Etc/Zulu",
                  "UTC","Universal","Zulu"];
...
all() -> ["GMT+2","WGST","CCT","ACWST","NPT","HKT","AZT","DAVT","GMT-7","MST",
          ...
          "MUT","TFT","KGT","COT","TKT","GMT+8","AFT","GILT","NFT","GMT+5",
          "ICT","EGT","FNT","BRT","WET","SAMT","AMST","MDT","PYT","SST",
          "ChST","IRST","AZST","AQTT","NUT","FJST","WAST","LHDT","PHT","SBT",
          "MAGT","DDUT","ADT","GMT+12","ORAT","XJT","GST","NDT","EET","RET",
          "UZT","FKST","QYZT","CAT","WITA","MIST"].