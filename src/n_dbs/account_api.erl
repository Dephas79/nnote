...
-record(n_account,
        {id = n_utils:create_id(), username, email, date = qdate:unixtime(), pwhash}).

-export([get_records_by_username/1, put_record/1, get_all_values/1, update_read/1,
         update_write/2, update_write/3, get_all/0, get_record/1, delete/1, map_to_record/1,
         record_to_map/1, new_account/3, attempt_login/2, id/1, username/1, email/1, date/1,
         pwhash/1, id/2, username/2, email/2, date/2, pwhash/2]).
